package Getperf::Command::Site::Db2::Db2MonSummary;
use strict;
use warnings;
use Data::Dumper;
use Time::Piece;
...
'SPACEMAPPAGE_RECLAIM_WAIT_TIME_PERCENT',  'SPACE_RECLAIM_PCT',
...
sub parse {
	...
	close($in);
	$data_info->regist_metric($host, 'Db2', 'db2_mon_summary', \@headers);
	my $output = "Db2/${host}/db2_mon_summary.txt";	# Remote collection
