...
.. note:: 以降の手順のコマンドプロンプトは"管理者権限付き"で起動してください。
...
.. note:: Windowsの場合、OSバージョン、32bit/64bitでダウンロードモジュールが異なることはなく、共通の手順となります。
...
以下コマンドで登録したサーバの転送データを確認します。

::

   find analysis/Windows/{サーバ名}
